...
describe "OmniAuth::Strategies::Bodymedia" do
  subject do
    OmniAuth::Strategies::Bodymedia.new(nil, @options || {})
  end

  context 'client options' do
    it 'has correct OAuth endpoint' do
      subject.options.client_options.site.should eq('https://api.bodymedia.com')
    end
